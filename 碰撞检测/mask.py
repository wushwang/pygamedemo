...
def main(*args):
    screen = pygame.display.set_mode((640,480)) # 生成一个窗口
    images = []  # 图片列表
    masks = []   # 蒙版列表
    for impath in args:
    ...
    for i in range(20):
        ...
        s.setPos((random.uniform(0,screen.get_width()), random.uniform(0,screen.get_height())))
